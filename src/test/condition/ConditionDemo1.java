...
public class ConditionDemo1 {
	...
	public static void main(String[] args) {
		...
		Runnable t3 = new DrawThread("王五", myCount, 12600);
		Runnable t5 = new DrawThread("老牛", myCount, 1300);
		Runnable t6 = new DrawThread("胖子", myCount, 800);
		Runnable t1 = new SaveThread("张三", myCount, 1000);
		Runnable t2 = new SaveThread("李四", myCount, 1000);
		Runnable t4 = new SaveThread("老张", myCount, 600);
		Runnable t7 = new SaveThread("测试", myCount, 2100);
		// 执行各个线程
